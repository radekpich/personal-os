...
export const api = {
  ...
  updateCategory: (id: string, payload: Partial<Pick<Category, "name" | "color" | "icon" | "parent_id" | "position" | "is_archived">>) => request<Category>(`/categories/${id}`, { method: "PATCH", json: payload }),
  deleteCategory: (id: string) => request<void>(`/categories/${id}`, { method: "DELETE" }),
  contexts: () => request<ListResponse<Context>>("/contexts"),
  createContext: (payload: Pick<Context, "name"> & Partial<Pick<Context, "color" | "icon" | "position" | "is_archived">>) => request<Context>("/contexts", { method: "POST", json: payload }),
  updateContext: (id: string, payload: Partial<Pick<Context, "name" | "color" | "icon" | "position" | "is_archived">>) => request<Context>(`/contexts/${id}`, { method: "PATCH", json: payload }),
  deleteContext: (id: string) => request<void>(`/contexts/${id}`, { method: "DELETE" }),
  ...
  updateTag: (id: string, payload: Partial<Pick<Tag, "name" | "color" | "icon" | "position" | "is_archived">>) => request<Tag>(`/tags/${id}`, { method: "PATCH", json: payload }),
